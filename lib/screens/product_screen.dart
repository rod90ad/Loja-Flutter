        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(productData.title, style: TextStyle(fontSize: 20, fontWeight: FontWeight.w500), maxLines: 3),
                Text("R\$ ${productData.price.toStringAsFixed(2)}", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: primaryColor)),
                SizedBox(height: 16),
                Text("Tamanho", style: TextStyle(fontWeight: FontWeight.w500, fontSize: 16)),
                SizedBox(
                  height: 34,
                  child: GridView(
                ...
                SizedBox(
                  ...
                  child: RaisedButton(
                    ...
                    child: Text(UserModel.of(context).isLoggedIn() ? "Adicionar ao Carrinho" : "Entre para Comprar", style: TextStyle(fontSize: 18)),
                    color: primaryColor,
