          ...
          Container(
            ...
            child: ScopedModelDescendant<CartModel>(
              builder: (context, child, model){
                ...
                return Text("${p?? 0} ${p==1 ? "ITEM" : "ITEMS"}", style: TextStyle(fontSize: 17));
              },
            ),
          )
        ],
      ...
      body: ScopedModelDescendant<CartModel>(
        builder: (context, child, model){
          if(model.isLoading && UserModel.of(context).isLoggedIn()){
            ...
            return Center(
              child: Text("Nenhum produto no carrinho", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),textAlign: TextAlign.center,),
            );
          } else{
            return ListView(
              children: <Widget>[
